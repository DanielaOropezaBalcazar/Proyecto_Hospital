...
public class atencion extends JFrame {
    ...
    public atencion() {
        ...
        btnGuardarCambios.setBounds(320, 540, 150, 30);
    ...
    private void cargarConsultasConCola() {
        ...
        String sql = "SELECT c.detalle, CONCAT(p.nombre, ' ', p.apellido) AS paciente, a.nivel_urgencia, c.codigo " +
                     "FROM atencion a " +
                     "JOIN consultas c ON a.consultaCodigo = c.codigo " +
        ...
        try (Connection con = conexion.conectar();
            ...
            while (rs.next()) {
                ...
                cola.add(consulta);// <-- Aquí se añade a la cola
            }

            while (!cola.isEmpty()) {
                Consulta c = cola.poll();// <-- Aquí se saca de la cola en orden de prioridad
